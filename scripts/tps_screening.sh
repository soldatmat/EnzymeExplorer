...
python -m enzymeexplorer.src.screening.tps_screening_cluster_launcher --session-i $SLURM_ARRAY_TASK_ID --fasta-path "$input_fasta_path" --output-root "$output_root_path" --detection-threshold "$detection_threshold"
